...
class Character2
{
  ...
  Character2(int x, int y, int h, int w, int sp, int j, int wei)
  {
    ...
    if (level==2) {
      ...
      rectangle[3] = new RectangleBoarder(800, 400, 400, 50);
      rectangle[4] = new RectangleBoarder(1100, 600, 400, 50);
      rectangle[5] = new RectangleBoarder(850, 800, 400, 50);
      rectangle[6] = new RectangleBoarder(500, 950, 1000, 50);
      enemy[0] = new EnemyCharacter(820, 375, 1170, 370, 5);
      enemy[1] = new EnemyCharacter(860, 775, 1240, 770, 9);
      enemy[2] = new EnemyCharacter(1100, 575, 1450, 570, 7);
    }
